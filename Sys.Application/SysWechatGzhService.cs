...
namespace Sys.Application
{
    ...
    /// 微信公众号
    /// </summary>
    public class SysWechatGzhService : ISysWechatGzhService
    {
        private readonly ISysWechatGzhManager _manager;
        public SysWechatGzhService(ISysWechatGzhManager manager)
        {
            _manager = manager;
        }
        ...
        {
            var data = SerializationHelper.DeserializeXml<WechatGzhEventForm>(xmlContent, Encoding.UTF8);
