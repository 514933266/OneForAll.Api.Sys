...
namespace Sys.Host.Controllers
{
    ...
    public class SysWechatGzhController : BaseController
    {
        private readonly IConfiguration _config;
        private readonly ISysWechatGzhService _service;
        public SysWechatGzhController(IConfiguration config, ISysWechatGzhService service)
        {
            _config = config;
            _service = service;
        }
