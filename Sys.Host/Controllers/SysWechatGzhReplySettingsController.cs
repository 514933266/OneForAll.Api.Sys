...
namespace Sys.Host.Controllers
{
    ...
    public class SysWechatGzhReplySettingsController : BaseController
    {
        private readonly ISysWechatGzhReplySettingService _service;

        public SysWechatGzhReplySettingsController(ISysWechatGzhReplySettingService service)
        {
            _service = service;
        }
        ...
        public async Task<PageList<SysWechatGzhReplySettingDto>> GetPageAsync(int pageIndex, int pageSize, [FromQuery] string appId)
        {
        ...
        /// </summary>
        [HttpPost]
        public async Task<BaseMessage> AddAsync([FromBody] SysWechatGzhReplySettingForm entity)
        {
        ...
        /// </summary>
        [HttpPut]
        public async Task<BaseMessage> UpdateAsync([FromBody] SysWechatGzhReplySettingForm entity)
        {
