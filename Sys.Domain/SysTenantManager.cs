...
namespace Sys.Domain
{
    ...
    { 
        ...
        private readonly ISysMidTenantPermRepository _tenantPermRepository;
        private readonly ISysMidUserPermRepository _userPermRepository;
        ...
        public SysTenantManager(
            ...
            ISysMidTenantPermRepository tenantPermRepository,
            ISysMidUserPermRepository userPermRepository,
            ISysMidRolePermRepository rolePermRepository,
        ...
        public async Task<BaseErrType> AddPermissionAsync(Guid id, IEnumerable<Guid> pids)
        {
            ...
            var addUserList = new List<SysMidUserPermission>();
            var addList = permissions.Select(s => new SysMidTenantPermission() { SysTenantId = id, SysPermissionId = s.Id }).ToList();

            users.ForEach(e =>
            {
                var list = permissions.Select(s => new SysMidUserPermission() { SysUserId = e.Id, SysPermissionId = s.Id }).ToList();
