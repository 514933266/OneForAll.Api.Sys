...
namespace Sys.Domain
{
    ...
    public class SysUserManager : BaseManager, ISysUserManager
    {
        ...
        public SysUserManager(
            ...
            ISysMidUserPermRepository userPermRepository) : base(httpContextAccessor)
        {
            _mapper = mapper;
        ...
        public async Task<PageList<SysUserAggr>> GetPageAsync(int pageIndex, int pageSize, string key)
        {
            ...
            return await _repository.GetPageWithTenantAsync(pageIndex, pageSize, key);
        }
        ...
        public async Task<BaseMessage> AddAsync(SysUserForm form)
        {
            ...
            var data = await _repository.GetAsync(form.UserName);
            if (data != null)
            {
            ...
            {
                var exists = await _repository.GetAsync(w => w.Mobile == form.Mobile);
                if (exists != null)
                {
                    msg.Data = exists.Id;
