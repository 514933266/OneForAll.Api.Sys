...
namespace Sys.Repository
{
    ...
    /// 角色权限
    /// </summary>
    public class SysMidRolePermissionRepository : Repository<SysMidRolePermission>, ISysMidRolePermRepository
    {
        public SysMidRolePermissionRepository(DbContext context)
            : base(context)
        {
        ...
        /// <returns>租户列表</returns>
        public async Task<IEnumerable<SysMidRolePermission>> GetListByTenantAsync(Guid tenantId)
        {
