...
namespace Sys.Repository
{
    ...
    public class SysWechatGzhSubscriberRepository : Repository<SysWechatGzhSubscriber>, ISysWechatGzhSubscriberRepository
    {
        ...
        public async Task<PageList<SysWechatGzhSubscriberAggr>> GetPageAsync(int pageIndex, int pageSize, string key)
        {
            ...
            var query = (from suser in DbSet
                         ...
                         select new SysWechatGzhSubscriberAggr()
                         {
                             Id = suser.Id,
                             AppId = suser.AppId,
            ...
            return new PageList<SysWechatGzhSubscriberAggr>(total, pageSize, pageIndex, data);
        }
        ...
        /// <returns>列表</returns>
        public async Task<IEnumerable<SysWechatGzhSubscriberAggr>> GetListByUserAsync(IEnumerable<Guid> userIds)
        {
