...
namespace Sys.Repository
{
    ...
    /// 角色用户
    /// </summary>
    public class SysMidRoleUserRepository : Repository<SysMidRoleUser>, ISysMidRoleUserRepository
    {
        public SysMidRoleUserRepository(DbContext context)
            : base(context)
        {
        ...
        /// <returns>租户列表</returns>
        public async Task<IEnumerable<SysMidRoleUser>> GetListByTenantAsync(Guid tenantId)
        {
